...
public class SidebarFoodFlow extends JPanel {
    ...
    private void construirUI() {
        ...
        int y = 60;
        y = addItem("Tablero Rutas",    "/com/foodflow/assets/ic_tablero.png", y, true);
        y = addItem("Pagos y Nóminas",  "/com/foodflow/assets/ic_pagos.png",   y, false);
        ...
        int bottomY = panel.getHeight() - (ITEM_H + 18);
        salir.setBounds(14, bottomY, panel.getWidth() - 28, ITEM_H);
